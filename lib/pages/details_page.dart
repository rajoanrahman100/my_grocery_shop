            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(20.0),
                    color: kWhiteColor,
                    boxShadow: [BoxShadow(blurRadius: 10, offset: Offset.zero, color: Colors.black.withOpacity(0.1))]),
                child: Row(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children:  [
                    ...
                    Text("\$$cost", style:const TextStyle(color: Colors.black, fontSize: 20.0, fontWeight: FontWeight.bold))
                  ],
                ),
              ),
              const SizedBox(
